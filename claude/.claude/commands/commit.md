...
- **Commit types**: Each commit should use an appropriate type:
  - `BREAKING CHANGE`: Changes that might cause the software to behave differently or require changes in configuration or setup
  - `feat`: New feature
  - `fix`: Bug fix
  - `perf`: Performance improvements
  - `docs`: Documentation only changes
  - `style`: Cosmetic changes that do not affect functionality
  ...
  - `chore`: Routine tasks or maintenance activities
