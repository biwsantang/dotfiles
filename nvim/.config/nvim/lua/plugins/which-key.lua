return {
  {
    ...
    config = function()
      ...
      wk.add({
        ...
        { "<leader>ft", desc = "Find tabs" },
        { "<leader>f3", group = "Symbols/Treesitter" },
        { "<leader>f3t", desc = "FZF Treesitter symbols" },
        { "<leader>f3s", desc = "FZF Document symbols" },
        { "<leader>f3S", desc = "FZF Workspace symbols" },
